...
- **🔢 Store'dan oxirgi build number** — Google Play API'dan haqiqiy oxirgi `versionCode` olinadi va undan `+1` qilinadi. versionCode conflict'ni butunlay yo'q qiladi (fastlane'ning `google_play_latest_version_code` kabi). Express'da avtomatik, interaktivda taklif qilinadi.
